...
const siteSettings = {
  ...
  social: [
    ...
    cta('social:linkedin', 'LinkedIn', 'https://www.linkedin.com/in/angelikacheng', 'outline', true),
  ],
  ...
  sections: [
    {
      ...
      intro: rich('contact:form:intro', ['A few lines about the project is enough to start. I will come back with questions or a proposed scope.']),
      nextSteps: rich('contact:form:next', [
        [{ text: 'What happens next. ', mark: 'strong' }, 'I read every inquiry myself and reply within a few business days with questions or a proposed scope. No booking is needed before we talk.'],
      ]),
      ...
      successHeading: 'Thanks, I have it.',
      successBody: rich('contact:form:success', ['I will reply within a few business days. If it is urgent, email me directly.']),
      errorBody: rich('contact:form:error', ['Something went wrong on my side and the message did not send. Please email me directly instead.']),
      emailNote: rich('contact:form:email', [['Prefer email? Write to ', { text: 'hello@angelikacheng.com', href: 'mailto:hello@angelikacheng.com' }, '.']]),
    },
    faq('contact:faq', [
      ...
      ['Can we talk before I fill in the form?', 'Yes. Email works just as well. The form simply helps me reply with something useful the first time.'],
